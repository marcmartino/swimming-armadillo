...
class UserData
{
     ...
     */
    public function getUserData($measurementTypeSlug, $startDatetime = null, $endDatetime = null)
    {
        ...
        $parameters = [
            ':measurementType' => $this->measurementType->getMeasurementType($measurementTypeSlug)['id'],
        ];
