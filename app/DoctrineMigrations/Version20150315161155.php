 ...
 */
class Version20150315161155 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    private $providerSlug = Providers::FATSECRET;

    private $providerName = 'FatSecret';
