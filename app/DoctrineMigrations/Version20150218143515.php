 ...
 */
class Version20150218143515 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    private $providerSlug = Providers::FITBIT;

    private $providerName = 'Fitbit';
